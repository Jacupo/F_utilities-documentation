...
\code{En GS Method Diag\_h:           -80.85277253997737}
  ...
  \centerline{
\includegraphics[width=0.7\textwidth]{figure/JLCODE3.pdf} }
...
\begin{align}
\langle a_l\da a_m\rangle (t) & = \frac{1}{N}\sum_{k,k'}e^{i(\phi_k-\phi_{k'})t}  e^{i\frac{2 \pi}{N} (k(l-x)-k'(m-y))}a_x\da a_y \\ %% f non b
\langle a_l a_m \rangle (t)     & = \frac{1}{N}\sum_{k,k'}e^{-i(\phi_{k}+\phi_{k'})t} e^{-i\frac{2 \pi}{N} (k(l-x)+k'(m-y))}a_x a_y.
\end{align}
